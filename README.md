...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/flat-mode-7c5d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/flat-mode-7c5d
```

A live public deployment of this template is available at [https://flat-mode-7c5d.templates.workers.dev](https://flat-mode-7c5d.templates.workers.dev)
